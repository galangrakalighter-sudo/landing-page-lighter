  ...
  return (
    <Element name="process-section">
      ...
      <div className="absolute inset-0 flex items-center justify-center text-white ml-[30%] md:ml-[50%]">
        <div>
          <h5 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-center text-white md:mr-5 font-[Arial,Helvetica,sans-serif]">BE PARTNERSHIP</h5>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mt-2 text-white font-[Arial,Helvetica,sans-serif]">WITH US NOW!</h1>
    ...
    <div className="grid grid-cols-3 w-full marqueChange h-10 bg-black" style={{ width: "100%"}}>
      <marquee behavior="scroll" direction="left" scrollamount="15" className="text-white font-semibold textMove mt-[4%] md:mt-[2%]" style={{ width: "300%", paddingBottom: "6%" }}>
