      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 relative">
          {steps.map((step, index) => (
            ...
            >
              {/* Icon Container */}
              <div className="w-20 h-20 bg-gray-800 border-2 border-slate-700 rounded-2xl flex items-center justify-center text-white-500 group-hover:bg-black group-hover:text-white group-hover:-translate-y-2 transition-all duration-300">
                {step.icon}
              </div>

              {/* Text Content */}
              <div className="space-y-3">
                <h3 className="sm:text-xl md:text-xl lg:text-[16px] font-bold font-[Arial,Helvetica,sans-serif] uppercase tracking-wide group-hover:text-blue-400 transition-colors">
                  {step.title}
                </h3>
              </div>
