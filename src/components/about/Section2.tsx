    ...
    <section id="why-digital-marketing-section" className="text-white py-16 bg-[#161616]">
        <div className="relative max-w-6xl mx-auto px-4 z-20">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
                <p className="indent-8 mt-4 text-white mx-auto text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl md:mx-0 font-[Arial,Helvetica,sans-serif]" id='paragraf_sec1'>
        ...
        <div className="grid grid-cols-3 text-center">
                {/* CLIENT */}
                <div className="p-6">
                    <p className="text-4xl font-extrabold text-white textChange">100 +</p>
